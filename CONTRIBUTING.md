...
```c
/*
 * Copyright 2017 Mezi language authors.
 *
...
Adding copyright notices other than the project-wide notice is not permitted. The only exception is adding third-party code which requires copyright notices to be preserved. Adding third-party code to the project generally requires a strong justification.

### 3. Sign your work with the Mezi language [Developer's Certificate of Origin](DCO.md)
...
"MeziLanguage-DCO-1.0-Signed-off-by:" this is a developer's certification that he or she has the right to submit the patch for inclusion into the project. It is an agreement to the Mezi language [Developer's Certificate of Origin](DCO.md). **Code without a proper signoff cannot be merged into the mainline.**
